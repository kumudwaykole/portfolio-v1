      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_.9fr] lg:items-start lg:gap-16">
          <div>
            <h2
              id="about-heading"
              className="text-[clamp(2.2rem,4.4vw,3.6rem)] font-bold leading-[1.05] tracking-[-.04em]"
            >
            ...
            <div className="mt-10 grid gap-8 sm:grid-cols-2">
              <p className="font-normal text-sm leading-7 text-zinc-500">
                I design and develop production-ready web applications with a
                strong focus on system design, database architecture,
                performance optimization, and scalable full-stack engineering.
              </p>
              <blockquote className="border-l-2 border-purple-400/40 pl-4 text-sm italic leading-7 text-zinc-300">
                &ldquo;I believe good engineering is where thoughtful
                architecture, clean code, and real-world impact come
                together.&rdquo;
                <footer className="mt-3 not-italic text-xs font-semibold text-zinc-500">
                  — Kumud Waykole, Developer
                </footer>
              </blockquote>
            </div>
          </div>
        ...
        <h3
          id="experience"
          className="mt-20 text-[clamp(2.6rem,9vw,7rem)] font-bold uppercase leading-[.85] tracking-[-.06em] sm:mt-28"
        >
          3+ YEARS
          <br />
        ...
        <div className="mt-12 grid gap-6 border-t border-white/10 pt-8 sm:grid-cols-[auto_1fr] sm:items-start sm:gap-16">
          ...
          <p className="max-w-2xl font-normal text-sm leading-7 text-zinc-500">
            Optimized system architecture, PostgreSQL database schemas, Redis
            caching, and logistics workflows to improve operational efficiency
