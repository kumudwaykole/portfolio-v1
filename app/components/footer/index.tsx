      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-7 pt-20 sm:px-8 sm:pt-28 lg:px-12">
        <div className="grid items-end gap-10 lg:grid-cols-[.95fr_1.05fr] lg:gap-16">
          ...
          <div className="group relative h-74 overflow-hidden border border-purple-300/35 bg-black transition-colors duration-300 hover:border-purple-300/55 sm:h-90">
            ...
            <div
              className="pointer-events-none absolute inset-x-[8%] bottom-[-35%] aspect-square rounded-full bg-[radial-gradient(circle_at_50%_38%,rgba(192,132,252,.16),rgba(126,34,206,.055)_38%,transparent_67%)] opacity-75 transition-opacity duration-500 group-hover:opacity-100"
              aria-hidden="true"
            />
          </div>
        </div>
        ...
        <div className="mt-10 grid gap-7 border-y border-white/10 py-4 sm:grid-cols-[1fr_auto] sm:items-end">
          ...
          <div className="flex gap-6 text-xs font-semibold uppercase tracking-wider text-zinc-400">
            <a
              href="https://github.com/kumudwaykole"
              target="_blank"
              rel="noreferrer"
